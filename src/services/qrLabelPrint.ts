...
<style>
  *{box-sizing:border-box}body{margin:0;padding:12mm;font-family:Arial,sans-serif;color:#081526;background:#fff}
  ...
  .qr-label-card{display:grid;grid-template-columns:34mm minmax(0,1fr);gap:5mm;align-items:center;min-height:45mm;padding:5mm;border:1px solid #b9c8d7;border-radius:5mm;break-inside:avoid;background:#fff}
